...
//                       BUTTON INPUT
// ---------------------------------------------------------------------------
#define BUTTON_A        0 //(1<<0)
#define BUTTON_B        1 //(1<<1)
#define BUTTON_SELECT   2 //(1<<2)
#define BUTTON_START    3 //(1<<3)
#define BUTTON_RIGHT    4 //(1<<4)
#define BUTTON_LEFT     5 //(1<<5)
#define BUTTON_UP       6 //(1<<6)
#define BUTTON_DOWN     7 //(1<<7)
#define BUTTON_R        8 //(1<<8)
#define BUTTON_L        9 //(1<<9)
